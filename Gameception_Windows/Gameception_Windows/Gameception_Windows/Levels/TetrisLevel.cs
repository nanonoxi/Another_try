...
namespace Gameception
{
    class TetrisLevel : Screen
    {
        ...
        public override void LoadContent()
        {
            ...
            player1 = new Player(content.Load<Model>("Models/player1_model"), 0.1f, 100, new Vector3(5, 3.5f, 0), 3.5f, camera, PlayerIndex.One);
            ...
            player2 = new Player(content.Load<Model>("Models/npc_model"), 0.1f, 100, new Vector3(-5, 4f, 0), 0.6f, camera, PlayerIndex.Two);
